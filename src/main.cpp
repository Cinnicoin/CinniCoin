...
int64 nChainStartTime = 1397809625;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if(nHeight <= 17280)
    {
        nSubsidy = 868 * COIN;	// 868 coins per block for the first three days.
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in CinniCoin
    bool fStrictPayToScriptHash = true; // Always active in CinniCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CinniCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Cinni Coin";
        CTransaction txNew;
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x1da9d2106a64c04bf77835fa53bb632203dcfaaf2816986d0b8d7f5b5d677f13"));
