...
void SendMessagesDialog::setModel(WalletModel *model)
{
    this->model = model;
...
void SendMessagesDialog::pasteEntry(const SendCoinsRecipient &rv)
{
...
void SendMessagesDialog::setBalance(qint64 balance, qint64 stake, qint64 unconfirmedBalance, qint64 immatureBalance)
{
    Q_UNUSED(stake);
...
void SendMessagesDialog::updateDisplayUnit()
{
    if(model && model->getOptionsModel())
    {
...
void SendMessagesDialog::coinControlButtonClicked()
{
...
void SendMessagesDialog::coinControlChangeChecked(int state)
{
    if (model)
    {
        if (state == Qt::Checked)
...
void SendMessagesDialog::coinControlChangeEdited(const QString & text)
{
    if (model)
    {
...
void SendMessagesDialog::coinControlUpdateLabels()
{
